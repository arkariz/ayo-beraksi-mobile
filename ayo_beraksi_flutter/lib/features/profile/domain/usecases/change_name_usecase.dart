...
class ChangeNameUseCase implements UseCase<DataState<ChangeNameMessage?>, ChangeNameParams> {
  final ProfileRepository _profileRepository;

  ChangeNameUseCase(this._profileRepository);

  @override
  Future<DataState<ChangeNameMessage?>> call({ChangeNameParams? params}) {
